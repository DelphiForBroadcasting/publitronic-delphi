...
function FastLocateByte(var Where; Start, BSize: Integer; What: Word): Integer; assembler; pascal;

// Find 2 bytes in buffer, return position or -1 if not found
function FastLocate2Bytes(var Where; Start, BSize: Integer; What: Word): Integer; assembler; pascal;
...
// Free if not nil and set to nil when done
...
function FastLocate2Bytes(var where; start, bsize: integer; what: word):integer; assembler; pascal; far;
asm
 push edi
 mov ecx, [bsize]
 sub ecx, [start]
